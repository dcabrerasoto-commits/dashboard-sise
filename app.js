        ...
        contenedor.innerHTML = `
            <div class="modal-grid kpi-section modal-kpi-grid">
                ...
                <div class="kpi-group-with-subgroups">
                    <div class="kpi-card brecha"><div class="kpi-label">N° de personas sin acreditación vigente</div><div class="kpi-value">${fmt(brechaRegional)}</div><div class="kpi-percent">No vigente + Sin acreditación previa.</div><div class="kpi-composition"><span>Composición</span><div><b>No vigente:</b> ${fmt(regionData.NoVigente)}</div><div><b>Sin acreditación previa:</b> ${fmt(regionData.NoAcreditado)}</div></div></div>
                    <div class="kpi-subgroup-stack">
                        <div class="kpi-card ambar kpi-subgrupo"><div class="kpi-subgroup-tag">Subgrupo de personas sin acreditación vigente</div><div class="kpi-label">N° de personas no vigentes</div><div class="kpi-value">${fmt(regionData.NoVigente)}</div><div class="kpi-percent">${porcentajeRatioEs(regionData.NoVigente, regionData.Total)} del total regional.</div></div>
                        <div class="kpi-card rojo kpi-subgrupo"><div class="kpi-subgroup-tag">Subgrupo de personas sin acreditación vigente</div><div class="kpi-label">N° de personas sin acreditación previa</div><div class="kpi-value">${fmt(regionData.NoAcreditado)}</div><div class="kpi-percent">${porcentajeRatioEs(regionData.NoAcreditado, regionData.Total)} del total regional.</div></div>
                    </div>
                </div>
            </div>
