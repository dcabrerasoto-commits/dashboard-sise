        ...
        contenedor.innerHTML = `
            <div class="modal-grid kpi-section modal-kpi-grid">
                ...
                <div class="kpi-group-with-subgroups">
                    ...
                    <div class="kpi-subgroup-stack">
                        <div class="kpi-card ambar kpi-subgrupo"><div class="kpi-label">N° de personas no vigentes</div><div class="kpi-value">${fmt(regionData.NoVigente)}</div><div class="kpi-description">Subgrupo de personas sin acreditación vigente</div><div class="kpi-percent">${porcentajeRatioEs(regionData.NoVigente, regionData.Total)} del total regional.</div></div>
                        <div class="kpi-card rojo kpi-subgrupo"><div class="kpi-label">N° de personas sin acreditación previa</div><div class="kpi-value">${fmt(regionData.NoAcreditado)}</div><div class="kpi-description">Subgrupo de personas sin acreditación vigente</div><div class="kpi-percent">${porcentajeRatioEs(regionData.NoAcreditado, regionData.Total)} del total regional.</div></div>
                    </div>
                </div>
            </div>
...
function renderDashboard() {
    ...
    document.getElementById("content").innerHTML = `
        ...
        <div class="executive-band">
            <div class="panel executive-main"><div class="executive-title">Lectura ejecutiva</div><div class="executive-text">${lecturaEjecutivaMes(monthData)}</div><div class="definitions-compact definitions-grouped"><div class="definition-group"><strong>Con acreditación vigente</strong><span>Persona con acreditación vigente en el mes seleccionado.</span></div><div class="definition-group definition-group-parent"><strong>Sin acreditación vigente</strong><span>Personas que actualmente no cuentan con acreditación activa.</span><div class="definition-subgroups"><span><b>No vigente:</b> persona que tuvo acreditación previa, pero no cuenta con vigencia actual.</span><span><b>Sin acreditación previa:</b> persona que no registra acreditación anterior.</span></div></div></div></div>
        ...
        <div class="kpi-section">
            ...
            <div class="kpi-group-with-subgroups">
                ...
                <div class="kpi-subgroup-stack">
                    <div class="kpi-card ambar kpi-subgrupo"><div class="kpi-label">N° de personas no vigentes</div><div class="kpi-value">${fmt(monthData.noVigente)}</div><div class="kpi-description">Subgrupo de personas sin acreditación vigente</div><div class="kpi-percent">${porcentajeRatioEs(monthData.noVigente, monthData.total)} del total de registros de ${mesNombrePropioText(monthData.label)}</div><div class="kpi-delta ${deltaNoVigente.className}">${deltaNoVigente.label}</div></div>
                    <div class="kpi-card rojo kpi-subgrupo"><div class="kpi-label">N° de personas sin acreditación previa</div><div class="kpi-value">${fmt(monthData.noAcreditado)}</div><div class="kpi-description">Subgrupo de personas sin acreditación vigente</div><div class="kpi-percent">${porcentajeRatioEs(monthData.noAcreditado, monthData.total)} del total de registros de ${mesNombrePropioText(monthData.label)}</div><div class="kpi-delta ${deltaNoAcreditado.className}">${deltaNoAcreditado.label}</div></div>
                </div>
            </div>
        </div>
        <div class="charts-section">
            <div class="chart-card"><div class="section-title">Evolución mensual según acreditación vigente</div><div class="section-note">Compara la evolución de los dos grupos principales: con acreditación vigente y sin acreditación vigente.</div><div class="chart-canvas-wrap"><canvas id="trendChart"></canvas></div></div>
            <div class="chart-card"><div class="section-title">Distribución por acreditación vigente</div><div class="section-note">Distribución del mes seleccionado según los dos grupos principales de acreditación.</div><div class="chart-canvas-wrap compact"><canvas id="estadoChart"></canvas></div></div>
        </div>
