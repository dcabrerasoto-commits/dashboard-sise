(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:720px){#resumen .kpi-grid{grid-template-columns:repeat(2,minmax(0,1fr))!important}.form-progress{grid-template-columns:1fr}#regionMap{grid-template-columns:1fr!important}}
